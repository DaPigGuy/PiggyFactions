...
class FactionMap
{
    ...
    public static function getMap(Player $player, int $width, int $height, float $yaw): array
    {
        ...
        $asciiCompass = self::getASCIICompass($yaw, TextFormat::RED, TextFormat::GOLD);
    ...
    public static function getASCIICompass(float $degrees, string $colorActive, string $colorDefault): array
    {
        $rows = [];
    ...
    public static function getCompassPointForDirection(float $degrees): ?string
    {
